package com.jimprince99.mbeans;
...
public class JMXLauncher {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JMXLauncher.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            objectName = new ObjectName("com.jimprince99.mbeans:type=basic,name=game");
